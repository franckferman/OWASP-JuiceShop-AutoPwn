...
# -*- coding: utf-8 -*-
"""
Module handling Juice Shop challenges automation.

Uses Selenium to interact with the web application.
...
from selenium_utils.selenium_utils import (
    open_url,
    wait_for_element_to_be_visible_by_css_selector,
    open_homepage_and_wait_for_juiceshop_logo,
    wait_for_element_to_be_clickable_and_click_by_css_selector,
    wait_for_element_to_be_clickable_by_css_selector,
    write_text_and_press_enter,
    write_text,
    refresh_url,
    parsing_currentpage,
)
