...
# -*- coding: utf-8 -*-
"""
Argument parser for OWASP Juice Shop AutoPwn.

Handles user inputs for target specification.
...
from utils.validations import ip_address_validation, domain_validation, port_validation
